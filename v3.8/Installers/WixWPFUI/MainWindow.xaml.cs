  ...
  public partial class MainWindow : BaseBAWindow
  {
    ...
    private void Execute(string action)
    {
      ...
      if (!string.IsNullOrEmpty(action))
      {
        ...
        Bootstrapper.Engine.NumericVariables["Enable36"] = (InstallData.HasBuildTools && InstallData.HasWix36) || InstallData.HasWixWPF36 ? 1L : 0L;
        Bootstrapper.Engine.NumericVariables["Enable37"] = (InstallData.HasBuildTools && InstallData.HasWix37) || InstallData.HasWixWPF37 ? 1L : 0L;
        Bootstrapper.Engine.NumericVariables["Enable38"] = (InstallData.HasBuildTools && InstallData.HasWix38) || InstallData.HasWixWPF38 ? 1L : 0L;
